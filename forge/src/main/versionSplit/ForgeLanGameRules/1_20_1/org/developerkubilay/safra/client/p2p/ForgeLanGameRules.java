...
public final class ForgeLanGameRules {
    ...
    public static GameRules createEditableGameRules(Minecraft client, Map<String, String> snapshot) {
        ...
        if (rules == null) {
            throw new IllegalStateException("Integrated server level is not available");
        }
    ...
    public static IntegratedServer getSingleplayerServer(Minecraft client) {
        Object server = call(client, new Class<?>[0], new Object[0], "getSingleplayerServer", "m_91092_");
        if (server == null) {
    ...
    public static int getServerPort(IntegratedServer server) {
        Object port = call(server, new Class<?>[0], new Object[0], "getServerPort", "method_3756", "M", "m_7448_");

...
public final class ForgeLanSessionState {
    ...
    private static volatile Map<String, String> gameRuleSnapshot = new LinkedHashMap<String, String>();
    private static volatile Map<String, String> defaultGameRuleSnapshot = new LinkedHashMap<String, String>();

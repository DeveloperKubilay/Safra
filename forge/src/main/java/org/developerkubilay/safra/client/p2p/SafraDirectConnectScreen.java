...
public final class SafraDirectConnectScreen extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.ipField = new GuiTextField(0, this.fontRenderer, this.width / 2 - 100, 116, 200, 20);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRenderer, I18n.format("selectServer.direct"), this.width / 2, 20, 0xFFFFFF);
        this.drawString(this.fontRenderer, I18n.format("addServer.enterIp"), this.width / 2 - 100, 100, 0xA0A0A0);

...
public final class FabricVersionCompat {
    ...
    private static Object resolveThirdServerInfoArgument(ServerInfo originalServerInfo, Class<?> thirdParameterType)
        ...
        Object value = readFieldValue(matchingField, originalServerInfo, thirdParameterType);
        if (value != null) {
            return value;
        }

        matchingField = findAssignableInstanceField(ServerInfo.class, thirdParameterType);
        value = readFieldValue(matchingField, originalServerInfo, thirdParameterType);
        if (value != null) {
            return value;
        }
        ...
        for (Method method : ServerInfo.class.getMethods()) {
            ...
            try {
                value = method.invoke(originalServerInfo);
                if (thirdParameterType.isInstance(value)) {
                    return value;
                }

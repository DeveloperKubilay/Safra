...
public final class SafraLanServerSettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 100, this.height / 4 + 48, 200, 20, Text.translatable("safra.p2p.server_settings.reset"), button -> {
        ...
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 100, this.height / 4 + 72, 200, 20, Text.translatable("safra.p2p.game_rules"), button -> {

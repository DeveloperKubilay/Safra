...
public final class P2pManager {
    ...
    public synchronized CompletableFuture<P2pShareCode> startHostingAsync(int tcpPort, String fixedCode, Runnable relayReadyHandler) {
        ...
        P2pHostService service = new P2pHostService(tcpPort, token, normalizedFixedCode, relayReadyHandler);
    ...
    public synchronized RewriteResult createRewrite(ServerInfo originalServerInfo) throws IOException {
    ...
    public CompletableFuture<RewriteResult> createRewriteAsync(ServerInfo originalServerInfo) {
        ...
        ServerInfo snapshot = new ServerInfo(originalServerInfo.name, originalServerInfo.address, originalServerInfo.isLocal());
        FabricClientCompat.copyServerInfo(snapshot, originalServerInfo);

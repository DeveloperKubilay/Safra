...
서버 설정이나 쓸데없는 단계로 시간 낭비하지 마세요.  
**2번 클릭**만으로 Minecraft 서버를 열고 바로 게임에 들어갈 수 있습니다.
...
> TLauncher 같은 다른 런처 유저가 들어올 경우, 서버를 여는 사람이 공유 전에 `online-mode=false` 만 설정하면 충분합니다.
...
<table>
  <tr>
    ...
    <td width="70%" align="left">
      ...
      ❤️ 소스코드에 접근 가능한 프로젝트는 여기 있습니다<br />

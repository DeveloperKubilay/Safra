...
サーバー設定や無駄な手順に時間を取られないでください。  
**2クリック**でMinecraftサーバーを起動して、そのままゲームに入れます。
...
> TLauncher など別のランチャーのプレイヤーが参加する場合は、サーバーを開く人が共有前に `online-mode=false` を設定すれば十分です。

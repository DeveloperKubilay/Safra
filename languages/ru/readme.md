...
Не трать время на настройку сервера и лишние шаги.  
Запусти свой сервер Minecraft в **2 клика** и сразу заходи в игру.

✅ Без сложного интерфейса 😌  
✅ Без лишних систем 🚫  
...
> Если будут заходить игроки с TLauncher или других лаунчеров, человеку, который запускает сервер, достаточно поставить `online-mode=false` перед тем как делиться игрой.

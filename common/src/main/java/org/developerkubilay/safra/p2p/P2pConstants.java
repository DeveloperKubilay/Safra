...
public final class P2pConstants {
    ...
    public static boolean hasRendezvousUrl() {
        return !Java8Compat.isBlank(rendezvousUrl());
    }

    public static boolean isValidRendezvousUrl(String url) {
        if (Java8Compat.isBlank(url)) {
            return false;
        }
